  ...
  return (
    <>
      {props.body == "input" && (
        <button
          type="button"
          className="btn border border-1 border-warning text-warning"
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              {props.body == "input" && (
                <FormEditTask
                  id={props.id}
                  subjectTask={props.subjectTask}
                  typeTask={props.typeTask}
                  descriptionTask={props.descriptionTask}
                  roleTask={props.roleTask}
                />
              )}

              {props.body == "changeColor" && <FormChangeColor />}
            </div>
          </div>
        </div>
      </div>
