...
export const Dashboard = (ev) => {
  ...
  const dailyTask = () => {
    let targetLength = 0;
    for (let index = 0; index < data.length; index++) {
      if (!data[index].role || !data[index].role) {
        targetLength++;
      }
    }
    return targetLength;
  ...
  return (
    <>
      ...
      <div className="row gy-4 gx-4">
        <BoxLink
          classCol={"col-lg-3 col-md-6 col-12"}
          title={"تسک های امروز"}
          link={"todaysTasks"}
          description={"تسک"}
          number={today_sTasks()}
        ...
        <BoxLink
          classCol={"col-lg-3 col-md-6 col-12"}
          title={"اهداف بلند مدت"}
          link={"longTermPurposes"}
          description={"هدف اصلی"}
          number={mainTarget() ?? 0}
          img={<img src={target} className="fit-contain" width={80} />}
        />
        <BoxLink
          classCol={"col-lg-3 col-md-6 col-12"}
          title={"مجموع تسک ها"}
          ...
          description={"تسک"}
          number={data.length}
          img={<img src={totalTask} className="fit-contain" width={80} />}
        />
